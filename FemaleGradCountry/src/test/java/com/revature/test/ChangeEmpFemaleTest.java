...
public class ChangeEmpFemaleTest {
	...
	@Before
	public void setUp() {
		ChangeEmpFemaleMapper mapper = new ChangeEmpFemaleMapper();
		mapDriver = new MapDriver<>();
		mapDriver.setMapper(mapper);
		
		ChangeEmpFemaleReducer reducer = new ChangeEmpFemaleReducer();
		...
		line = new Text("\"Argentina\",\"ARG\",\"Employment to population ratio, 15+, female (%) (modeled ILO estimate)\",\"SL.EMP.TOTL.SP.FE.ZS\","
				+ "\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\""
	...
	public void testMapper() {
		...
		//Expected Output
		mapDriver.withOutput(new Text("Female Average Employement Change"), new FloatWritable(0));
		mapDriver.runTest();
	}
	...
	public void testReducer() {
		...
		reduceDriver.withInput(new Text("Female Average Employement Change"), values);
		
		reduceDriver.withOutput(new Text("Female Average Employement Change"), new FloatWritable(0));
	...
	public void testMapReduce() {
		...
		reduceDriver
		.withOutput(new Text("Female Average Employement Change"), new FloatWritable(0));
	}
