 ...
 * It processes only the lines with the indicator code 'SL.EMP.TOTL.SP.FE.ZS' iterates through the received values to calculate the average for a specific country
 * @author cloudera
 *
 */
